          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                >
                  Premium Blend Coffee is a rich and aromatic brew, crafted to deliver a perfectly balanced flavor. It's the ideal choice for coffee lovers seeking quality in every sip.
                </p>
